...
[![alliage](https://img.shields.io/npm/v/alliage/latest?color=%2300CC00&label=alliage%40latest)](https://www.npmjs.com/package/alliage)
...
The registering of a module happens in the `alliage-modules.json` created earlier.
...
```js
import { CommandBuilder } from 'alliage/core/utils/cli';
...
```js
import { CommandBuilder, ArgumentsParser } from 'alliage/core/utils/cli';
...
export = class MySecondModule extends AbstractModule {
  public getKernelEventHandlers() {
    return {
      run: this.onRun,
    };
